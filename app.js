...
const QUIZZES = {
  ...
  5: [{
    ...
    zones: [{ z: 'ours', l: '우리 기관 IRI' }, { z: 'world', l: '국제 전거 IRI' },
      { z: 'name', l: '이름일 뿐' }, { z: 'page', l: '웹페이지일 뿐' }],
    items: [
    ...
    key: { a: 'ours', b: 'name', g: 'page', e: 'world', c: 'ours', k: 'name', h: 'page', lc: 'world', d: 'name', j: 'page' },
    why: {
