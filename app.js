...
<tr><td><code>410</code></td><td><b>종료</b> — 있었으나 거두었다</td><td>잘못 만든 전거를 폐기할 때</td></tr>
</table></div>
<p class="note"><code>410</code> 과 <code>404</code> 는 다릅니다. <code>404</code> 는 “모른다”이고
<code>410</code> 은 <b>“있었는데 거두었다”</b>입니다 — 폐기했다는 사실 자체가 남겨야 할 기록이므로,
빈 응답 대신 <b>왜 거두었고 무엇으로 갈음하는지 적은 문서</b>를 함께 돌려줍니다.
식별자를 지우는 일과 폐기를 남기는 일은 다릅니다.</p>
<div class="scroll wide"><table>
...
const QUIZZES = {
  ...
  5: [{
    ...
    why: {
      ...
      nl: '국립중앙도서관이 부여한 <b>사람</b>의 IRI 이고, <code>owl:sameAs</code> 로 VIAF·위키데이터·ISNI 에 물려 있습니다 — 여기까지는 흠잡을 데가 없습니다. 그런데 <b>지금 이 주소는 작동하지 않습니다.</b> 정본이 <code>http</code> 인데 그 호스트가 <code>https</code> 만 받고, 넘겨 주는 자리도 죽은 <code>http</code> 주소입니다. <b>모델이 훌륭해도 닿지 않으면 아무도 따라오지 못합니다.</b>',
