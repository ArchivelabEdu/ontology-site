...
<p>낯설게 느껴지겠지만, 지식그래프는 이미 검색창 옆에 매일 떠 있습니다.
구글에서 <b>“정세균”</b>을 검색하면 오른쪽에 이런 상자가 뜹니다.</p>
<figure>
  <img src="assets/google-knowledge-panel.jpg" alt="구글에서 '정세균'을 검색했을 때 뜨는 지식패널 — 이름, '전 대한민국 국무총리'라는 직함, 사진, 나이, 학력, YouTube·Instagram 링크가 함께 표시된다">
  <figcaption>구글 검색 “정세균” · 오른쪽 지식패널(Knowledge Panel), 2026-08 화면</figcaption>
</figure>
<p>이 상자는 사람이 하나하나 그려 넣은 게 아닙니다. 구글은 <b>웹 전체를 읽어 이런 상자를 자동으로 만듭니다</b> —
페이지에 심어 둔 <code>schema.org</code> 구조화 데이터(“이 사람의 생년월일은 이것, 직함은 이것”)를 읽어 개체와 사실을 뽑고,
위키백과 같은 공개 출처와 협력사 데이터를 더하고, 본인·기관처럼 <b>검증된 개체가 직접 수정을 제안</b>할 길도 열어 둡니다.
<span style="display:block;font-size:.76rem;color:var(--muted);margin-top:.4rem">Google Search Central, <i>Understand How Structured Data Works</i> ·
Google 고객센터, <i>지식패널 정보의 출처</i></span></p>
<p><b>이 장에서 배운 것과 정확히 같은 모양입니다.</b> “정세균”이라는 <b>개체</b>가 하나로 묶이고,
나이·학력 같은 <b>값</b>이 붙고, YouTube·Instagram 같은 <b>다른 자원으로 이어지는 선</b>이 걸립니다.
개체 하나를 중심에 놓고 사실과 관계를 모으는 이 형식이 있어야 “다른 정세균과 안 헷갈리고”,
“나이를 검색하면 바로 나오고”, “관련 채널까지 따라갈 수” 있습니다.</p>
<p class="note">다만 <b>다섯 요건을 다 채우지는 않습니다.</b> 구글의 그래프는 안쪽에 있고, 이 상자가 가리키는 식별자를
남이 가져다 <code>owl:sameAs</code>로 이을 수 있게 공개하지 않습니다 — 5장에서 본 <b>“열려야 진짜 IRI”</b>라는
기준에서 보면, 이것은 <b>지식그래프의 결과 화면</b>이지 <b>열린 지식그래프 그 자체</b>는 아닙니다.
아래 다섯 가지는 그 차이, 곧 <b>우리가 만드는 것은 무엇을 더 갖춰야 하는지</b>를 정리한 것입니다.</p>
